...
struct SampleData {
    static let user: [User] = {
        ...
        user.coffeeNotes = [
            CoffeeNote(name: "커피 샘플1", date: Date(), type: coffeeTypes[0], flavors: [coffeeFlavors[0], coffeeFlavors[6]], taste: [5, 4, 3, 3, 4], think: "커피 후기1", rating: 4.5),
            CoffeeNote(name: "커피 샘플2", date: Date()-1000, type: coffeeTypes[2], flavors: [coffeeFlavors[1], coffeeFlavors[3]], taste: [3, 4, 3, 3, 4], think: "커피 후기2", rating: 3.5)
        ]
        return [user]
    }()
}
